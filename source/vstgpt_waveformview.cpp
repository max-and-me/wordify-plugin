...
//------------------------------------------------------------------------
void WaveformView::drawFull(VSTGUI::CDrawContext *pContext, const VSTGUI::CRect &viewSize)
{
...
//------------------------------------------------------------------------
void WaveformView::drawSimplified(VSTGUI::CDrawContext *pContext, const VSTGUI::CRect &viewSize)
{
