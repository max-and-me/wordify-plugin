...
//------------------------------------------------------------------------
template <class T>
auto create_multi_channel_buffers(size_t num_channels,
                                  size_t num_samples) -> MultiChannelBuffers<T>
{
...
//------------------------------------------------------------------------
template <class T>
auto to_interleaved(const MultiChannelBuffers<T>& multi_channel_bufs)
    -> AudioBuffer<T>
{
